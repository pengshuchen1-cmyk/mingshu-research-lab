...
from .ziwei_constants import BRANCHES, PALACE_EXPLANATIONS, PALACE_NAMES
from .ziwei_star_engine import (
    calculate_ziwei_main_stars,
    get_year_branch_from_profile,
    get_year_gan_from_profile,
)
...
def _integrate_minor_fierce_stars(chart: dict, profile: dict) -> dict:
    ...
    year_branch = ""
    try:
        from .ziwei_star_engine import get_year_branch_from_profile, get_year_gan_from_profile
    ...
    if hour_branch and lunar_month:
        from .ziwei_minor_star_engine import calculate_all_minor_stars
        minor_results = calculate_all_minor_stars(hour_branch, lunar_month)

    # 煞星
    fierce_results = {}
    if year_gan and year_branch and hour_branch:
        from .ziwei_fierce_star_engine import calculate_all_fierce_stars
    ...
    try:
        ...
        if gender:
            from .ziwei_daxian_engine import calculate_daxian
