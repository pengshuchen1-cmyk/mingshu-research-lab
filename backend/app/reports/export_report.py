...
from ..fortune.narrative_engine import build_luck_stage_narrative, remove_repetitive_sentences
from .sixty_jiazi_report import build_sixty_jiazi_markdown
from .special_report_common import build_special_markdown
from .useful_god_report import generate_useful_god_explanation
...
def _build_five_element_deep_section(chart: dict, bullet: str = "-") -> list[str]:
    """生成五行结构深度分析导出段落。"""
    try:
        from .five_element_deep_report import generate_five_element_deep_report
