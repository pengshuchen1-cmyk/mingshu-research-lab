...
from .export_report import DISCLAIMER
...
def _build_life_manual_sections(chart: dict, msbp: dict, misbp: dict, fsbp: dict, sbp: dict) -> list[dict]:
    ...
    from ..ziwei.ziwei_constants import DETAILED_PALACE_EXPLANATIONS
    from ..ziwei.ziwei_star_palace_engine import build_star_palace_explanations
    from ..ziwei.ziwei_triangle_engine import get_sanfang_sizheng
...
def generate_ziwei_report(chart: dict) -> dict:
    ...
    sihua_data = {}
    try:
        from ..ziwei.ziwei_sihua_engine import apply_sihua_to_chart, get_sihua_by_year_gan
        from ..ziwei.ziwei_star_engine import get_year_gan_from_profile
    ...
    from ..ziwei.ziwei_constants import DETAILED_PALACE_EXPLANATIONS
    from ..ziwei.ziwei_readable_engine import build_ziwei_capability_review, build_ziwei_plain_guide
    from ..ziwei.ziwei_triangle_engine import get_sanfang_sizheng
