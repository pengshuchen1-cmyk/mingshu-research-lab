...
from .bazi_calendar_adapter import BirthInput, normalize_birth_input
...
from .bazi_rulebook import load_rulebook
from .chart_facts import attach_chart_facts
from .dayun_rule_engine import calculate_dayun
from .five_elements import calculate_five_elements
from .four_pillars_engine import calculate_four_pillars
...
from .strength_engine import analyze_day_master_strength
from .ten_gods import count_ten_gods, get_hidden_stem_ten_gods, get_ten_god
from .wealth_analysis import analyze_wealth
...
def ensure_bazi_analysis_fields(chart: dict) -> dict:
    ...
    if "seasonal_adjustment" not in chart:
        ...
        except Exception as exc:  # noqa: BLE001 - preserve partial chart fallback
...
def build_bazi_chart(profile: dict) -> dict:
    ...
    try:
        ...
        return chart
    except Exception as exc:  # noqa: BLE001 - public domain error boundary
