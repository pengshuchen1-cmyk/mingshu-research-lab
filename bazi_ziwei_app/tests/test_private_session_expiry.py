...
def _private_state(now):
    return {
        ...
        "current_year_analysis_key": "private-analysis-key",
        "current_report_export_key": "private-export-key",
        "current_report_markdown": "private markdown",
        "current_report_text": "private text",
        "current_report_pdf": b"private pdf",
